...
(defvar my-xdg-cache (or (getenv "XDG_CACHE_HOME") (expand-file-name "~/.cache/")))
(defvar my-xdg-state (or (getenv "XDG_STATE_HOME") (expand-file-name "~/.local/state/")))
(defvar my-xdg-config (or (getenv "XDG_CONFIG_HOME") (expand-file-name "~/.config/")))
